...
-(void)respondWithRAC
{
    ...
    //付款
    [[[[NSNotificationCenter defaultCenter]rac_addObserverForName:@"clickBtnPayFromAllOrderVC" object:nil]takeUntil:self.rac_willDeallocSignal]subscribeNext:^(NSNotification * _Nullable x) {
