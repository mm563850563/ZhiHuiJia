//
//  OrderListViewController_Three.m
//  ZHJ_rebuild
//
...
@interface OrderListViewController_Three ()<UITableViewDelegate,UITableViewDataSource,OrderListFooterViewDelegate>
...
@implementation OrderListViewController_Three
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    headerView.labelOrderState.text = @"待发货";
    return headerView;
}
