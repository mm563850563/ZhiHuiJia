...
@interface WeChatAccountViewController ()
@property (weak, nonatomic) IBOutlet UIImageView *imgWeChatAccount;

@end

@implementation WeChatAccountViewController
...
#pragma mark - <获取公众号数据>
-(void)getWechatAccountData
{
    NSString *urlStr = [NSString stringWithFormat:@"%@%@",kDomainBase,kWechatAccount];
...
-(void)fillDataWithResult:(NSDictionary *)result
{
    ...
    [self.imgWeChatAccount sd_setImageWithURL:url placeholderImage:kPlaceholder];
}
